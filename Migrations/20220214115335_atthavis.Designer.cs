...
namespace LaundryManagerAPI.Migrations
{
    ...
    [Migration("20220214115335_atthavis")]
    partial class atthavis
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LaundryManagerAPI.Models.Bill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LaundryManagerAPI.Models.Locality", b =>
                {
                    ...
                    b.HasIndex("LocalArea")
                        .IsUnique()
                        .HasFilter("[LocalArea] IS NOT NULL");
            ...
            modelBuilder.Entity("LaundryManagerAPI.Models.Membership", b =>
                {
                    ...
                    b.HasIndex("MembershipName")
                        .IsUnique();

                    b.ToTable("tblMembership");
                });

            modelBuilder.Entity("LaundryManagerAPI.Models.PhycalRole", b =>
                {
                    ...
                    b.HasIndex("PhyRole")
                        .IsUnique()
                        .HasFilter("[PhyRole] IS NOT NULL");

                    b.ToTable("tblPhycalRole");
                });
            ...
            modelBuilder.Entity("LaundryManagerAPI.Models.Recharge", b =>
                {
                    ...
                    b.Property<double>("RechargeAmnt")
                        .HasColumnType("float");
                    ...
                    b.ToTable("tblRecharge");
                });

            modelBuilder.Entity("LaundryManagerAPI.Models.UserType", b =>
                {
